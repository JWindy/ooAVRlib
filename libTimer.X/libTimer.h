...
Dependencies:   either timer0 or timer1 , check #include for required libraries
                PWM is hard coded to toggle PB0 and/or PB1 and/or PB4. Compare match timer0 depends on OCA0A, 
                compare match timer1 on OCR1C.
...
//The available timer0 prescalers are commented
